...
reader.onload = function (e) {
  ...
  if (coreToggleInput) {
    ...
    coreToggleInput.dispatchEvent(new Event("change")); // trigger visual updates
  }

  // Dots (skills, health, sanity, etc.)
  document.querySelectorAll(".dot").forEach((dot, i) => {
...
// Close menu when clicking any menu item inside it
