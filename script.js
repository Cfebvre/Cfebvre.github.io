...
const darkToggleMenu = document.getElementById("dark-toggle-menu");

// Load saved preference
if (darkToggleMenu) {
  if (localStorage.getItem("darkMode") === "true") {
    document.body.classList.add("dark");
    darkToggleMenu.checked = true;
  }

  darkToggleMenu.addEventListener("change", () => {
    const isDark = darkToggleMenu.checked;
...
if (localStorage.getItem("darkMode") === "true") {
  document.body.classList.add("dark");
  if (darkToggleMenu) darkToggleMenu.checked = true;
}
